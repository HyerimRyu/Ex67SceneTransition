package kr.co.teada.ex67scenetransition;
...
public class MainActivity extends AppCompatActivity {
    ...
    RelativeLayout rootLayout; //activity_main.xml 의 레이아웃
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //장면(Scene)을 담을 ViewGroup
        rootLayout=findViewById(R.id.layout_root);

        //2개의 장면[레이아웃 파일] 객체 생성
    ...
    public void clickBtn1(View v){
        //.enter()는 장면은 바뀌지만 전환 효과는 없어

        //전환효과를 주기 위해 전환 효과 객체를 만들기
